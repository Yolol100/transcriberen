        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            for relative in m.REQUIRED:
                ...
                if relative == "toolkit-contract.json":
                    path.write_text('{"source_set_version":"2.2.0-captions-only","runtime_target":"self-hosted-or-local-direct-network","tools":[{"id":"yt-dlp"},{"id":"deno-ejs-runtime"}]}', encoding="utf-8")
